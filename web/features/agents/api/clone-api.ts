import { getAgent, createAgent, updateAgent } from './agents-api';
import { getAgentMemories, getAgentFiles, getAgentFileContent } from './index';
import { Agent, CreateAgentInput, UpdateAgentInput } from '../types';
import type { CloneAgentOptions, CloneAgentResult } from '../types';

export type { CloneAgentOptions, CloneAgentResult };
      ...
      try {
        ...
        for (const file of files) {
          ...
          try {
            ...
            // Upload to new agent - will throw since backend doesn't support it
            // but we'll catch and continue
