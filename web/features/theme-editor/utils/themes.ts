...
import type { ColorTheme, ColorThemeConfig } from '../types';
import { OKLCH, mixOklch } from './oklch-palette';

// Re-export types and palette for backward compatibility
export type { ColorTheme, ColorThemeColors, ColorThemeConfig } from '../types';
export { OKLCH, mixOklch } from './oklch-palette';
