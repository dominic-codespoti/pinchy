...
// Types and OKLCH palette are now imported from canonical sources
import type { ColorTheme, ColorThemeConfig, OklchColor } from '../types';
import { OKLCH } from './oklch-palette';

// Re-export OKLCH for backward compatibility
export { OKLCH } from './oklch-palette';
